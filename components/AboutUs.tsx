    ...
    <div className="max-w-4xl mx-auto px-6 py-12 md:py-24">
      ...
      <div className="space-y-16">
        <header className="space-y-6">
          ...
          <h1 className="text-5xl md:text-8xl font-black text-slate-900 tracking-tighter leading-none">The Shinobi Protocol.</h1>
          <p className="text-2xl text-slate-500 font-medium max-w-2xl leading-relaxed">
            ValuNinja was born from a simple realization: <span className="text-indigo-600">The market is bloated, and transparency is hidden in the shadows.</span>
          </p>
        </header>
        ...
        <section className="bg-slate-900 text-white rounded-[3rem] p-10 md:p-16 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <p className="text-xl text-slate-300 leading-relaxed">
              We built ValuNinja to act as a silent, autonomous agent for the consumer. Most "top 10" lists are loud advertisements. We use silent observation—specs, real-time pricing, and build quality analytics—to calculate a <strong>Value Score</strong> that remains untainted by bias.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-white/10">
              ...
              <div className="space-y-3">
                ...
                <h4 className="font-black text-xl">Targeted Recon</h4>
                <p className="text-slate-400 text-sm">We infiltrate local inventory nodes that loud search engines might miss.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-slate-600 leading-relaxed">
                To keep this intelligence free for every agent, we use a reward-based referral model. When you click a "Direct Strike" link and acquire a target, we may receive a commission. 
              </p>
              <div className="bg-amber-50 border-l-4 border-amber-500 p-6 rounded-r-2xl">
                <p className="text-sm font-bold text-amber-900 italic">
                  "Important: We do not prioritize retailers based on bounty size. If a better deal exists at a source that pays us nothing, it remains the Alpha Target. Our algorithm is blind to the reward."
                </p>
              </div>
            </div>
        ...
        <section className="bg-indigo-50 border border-indigo-100 rounded-[3rem] p-10 md:p-14">
           <div className="max-w-xl mx-auto text-center space-y-6">
              ...
              <p className="text-slate-600 font-medium">Spotted a compromised deal? Want to join the intelligence network? Deploy a signal to our masters.</p>
        ...
        <section className="text-center py-12 border-t border-slate-100">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 mb-8">Shinobi Intelligence Protocol 2026</p>
